...
if __name__ == '__main__':
    csv_file = "csv_labels_png.csv"
    image_dir = "/home/xujialang/cervical_detection/samples_img_png/"
    saved_coco_path = "/home/xujialang/data/"
    # 整合csv格式标注文件
    ...
    #train_keys, val_keys = train_test_split(total_keys, test_size=0.0)
    print("train_n:", len(total_keys))#'val_n:', len(val_keys))
    # 创建必须的文件夹
    ...
    train_instance = l2c_train.to_coco(total_keys)#train_keys
    l2c_train.save_coco_json(train_instance, '%scoco/annotations/instances_train2017.json'%saved_coco_path)
    # for file in total_keys:#train_keys
